...
public CustomerApplyPolicieRepo getApprepo() {
	return apprepo;
}

public void setApprepo(CustomerApplyPolicieRepo apprepo) {
	this.apprepo = apprepo;
}

public PolicysService getPolicysService() {
	return policysService;
}

public void setPolicysService(PolicysService policysService) {
